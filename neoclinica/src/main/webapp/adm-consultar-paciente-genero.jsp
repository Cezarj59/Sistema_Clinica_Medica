...
<body class="bg-primary">
	...
	<div class="container mt-4 bg-light p-3">
		<h4 class="text-center">Pesquisa de Pacientes por Gênero</h4>

		<form
			class="container d-flex justify-content-center align-items-center "
			action="admConsultarPacientesGenero" method="POST">
			<div class="row">
				<div class="col-sm-8">
	...
	<main class="container mt-4 bg-light">
		...
		<section>
			<c:choose>
				...
				<c:otherwise>
					<p class="text-center">Ainda não há pacientes cadastrados.</p>
				</c:otherwise>
			</c:choose>
		</section>
	</main>

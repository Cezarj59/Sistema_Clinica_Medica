...
<body class="bg-primary">
	...
	<div class="container mt-4 bg-light p-3">
		<h1>Pesquisar Agendamentos por Dia da Semana</h1>
		<form action="admConsultarAgendamentosDia" method="POST">
			<div class="mb-3">
				<label for="diaSemanaSelect" class="form-label">Escolha um
					dia da semana:</label> <select class="form-select" id="diaSemanaSelect"
					name="diaSemanaSelect" required>
					...
					<!-- Adicione mais opções para os outros dias da semana se necessário -->
				</select>
			</div>

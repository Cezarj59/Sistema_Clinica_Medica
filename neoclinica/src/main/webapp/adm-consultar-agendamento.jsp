			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<li><a class="dropdown-item" href="admConsultarMedicos">Todos os médicos</a></li>
							<li><a class="dropdown-item" href="adm-consultar-medicos-especialidade.jsp">Por especialidade</a></li>
						</ul></li>
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<li><a class="dropdown-item" href="">Todos em aberto</a></li>
							<li><a class="dropdown-item" href="">Todos realizados</a></li>
							<li><a class="dropdown-item" href="">Por dia</a></li>
							<li><a class="dropdown-item" href="">Por semana</a></li>
							<li><a class="dropdown-item" href="">Por paciente</a></li>
							<li><a class="dropdown-item" href="">Por paciente em
									aberto</a></li>
							<li><a class="dropdown-item" href="">Por paciente já
									realizados</a></li>
						</ul></li>
				</ul>
			</div>

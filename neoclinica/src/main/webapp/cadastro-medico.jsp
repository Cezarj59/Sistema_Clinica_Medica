...
<body>
	...
	<div class="container background-column">
		<div class="row justify-content-center">
			<div class="col-md-6">
				<form class="custom-form" name="form-cadastrar-medico"
					id="form-cadastrar-medico" method="POST" action="cadastrarMedico">
					<fieldset>
						<!-- Form Name -->
						<legend class="text-center">Cadastro de Médico</legend>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="inputNome"
									...
									class="form-text text-light">Nome do medico</span>
							</div>
						</div>
						...
						<!-- Text input-->
						<div class="row mb-3">
							<label for="inputCrm" class="col-sm-3 col-form-label text-end">CRM/UF</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="inputCrm"
									name="inputCrm" placeholder="" required=""> <span
									class="form-text text-light">ex:123455/SP</span>
							</div>
						</div>
						<div class="row mb-3">

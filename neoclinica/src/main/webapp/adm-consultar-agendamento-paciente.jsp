...
<div class="container mt-4 bg-light p-3">
    ...
    <form action="admConsultarAgendamentosPorPaciente" method="POST">
        <div class="mb-3">
            <label for="nomeCpfInput" class="form-label">Nome do paciente ou CPF:</label>
            <input type="text" class="form-control" id="nomeCpfInput" name="nomeCpfInput">
        </div>
        <div class="mb-3">
            <label class="form-label">Tipo de pesquisa por paciente:</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipoPesquisa" id="tipoPorPaciente" value="porPaciente">
                <label class="form-check-label" for="tipoPorPaciente">
                    Por paciente
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipoPesquisa" id="tipoPacienteAberto" value="porPacienteAberto">
                <label class="form-check-label" for="tipoPacienteAberto">
                    Por paciente em aberto
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipoPesquisa" id="tipoPacienteRealizados" value="porPacienteRealizados">
                <label class="form-check-label" for="tipoPacienteRealizados">
                    Por paciente já realizados
                </label>
            </div>
        </div>
